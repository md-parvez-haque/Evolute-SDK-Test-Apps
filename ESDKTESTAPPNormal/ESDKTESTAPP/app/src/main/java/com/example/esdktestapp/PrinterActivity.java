...
public class PrinterActivity extends AppCompatActivity {
    ...
    Button btn_printtext, btn_print, btn_rawdata, btn_justification, btn_printQR, btn_printimage, btn_printbarcode128;
...
//                        break;
                ...
                new Handler(Looper.getMainLooper()).post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            Toast.makeText(PrinterActivity.this, "Testprint is : " + finalB1, Toast.LENGTH_SHORT).show();
                        }
                    });
